...
function ErrorNotice({ error, retry = false }: { error: Error; retry?: boolean }) {
  ...
  return (
    <div role="alert" className="bg-red-100 dark:bg-red-900 border border-red-200 dark:border-red-800 rounded-lg shadow-md p-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <button type="button" onClick={reloadPage} className="px-4 py-2 bg-red-600 text-white text-xs font-medium rounded hover:bg-red-700 transition-colors motion-reduce:transition-none">
      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        {error && !data ? (
          ...
          <div role="status" className="flex flex-col justify-center items-center py-20">
            <div aria-hidden="true" className="w-8 h-8 mb-4 rounded-full border-4 border-blue-200 border-t-blue-500 motion-safe:animate-spin" />
